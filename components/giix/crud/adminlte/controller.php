...
<?php else: ?>
use yivic\yivicCms\libs\override\db\NpActiveDataProvider as ActiveDataProvider;
<?php endif; ?>
use <?= ltrim($generator->baseControllerClass, '\\') ?> as Controller;
use yivic\yivicCms\libs\override\web\NpNotFoundHttpException as NotFoundHttpException;
use yivic\yivicCms\libs\override\filters\NpVerbFilter as VerbFilter;
use yivic\yivicCms\libs\override\helpers\NpArrayHelper as ArrayHelper;
use yivic\yivicCms\libs\helpers\NpDateTimeHelper as DateTimeHelper;
