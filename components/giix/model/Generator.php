...
namespace yivic\yivicCms\components\giix\model;
...
{
    public $db = 'db';
    public $ns = 'yivic\yivicCms\models';
    public $nsCommon = 'yivic\yivicCms\models';
    public $nsCommonBase = 'yivic\yivicCms\models\base';
    public $tableName;
    public $modelClass;
    public $baseClass = 'yivic\yivicCms\libs\NpActiveRecord';
    public $generateRelations = true;
    public $generateLabelsFromComments = false;
    public $useTablePrefix = false;
    public $useMidClass = false;
    public $useSchemaName = true;
    public $generateQuery = false;
    public $queryNs = 'yivic\yivicCms\models\query';
    public $queryClass;
    public $queryBaseClass = 'yivic\yivicCms\libs\NpActiveQuery';
    ...
    {
        return 'Giix (YivicCms) Model Generator';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['ns', 'queryNs', 'nsCommonBase'], 'filter', 'filter' => function($value) { return trim($value, '\\'); }],
...
//            [['baseClass'], 'validateClass', 'params' => ['extends' => $this->baseClass]],
//            [['queryBaseClass'], 'validateClass', 'params' => ['extends' => $this->queryBaseClass]],
            [['generateRelations', 'generateLabelsFromComments', 'useTablePrefix', 'useMidClass', 'useSchemaName', 'generateQuery'], 'boolean'],
            [['enableI18N'], 'boolean'],
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            //Generate Base Model
            $baseNs = $this->ns ? $this->ns.'/base' : $this->nsCommonBase;
            $files[] = new CodeFile(
                Yii::getAlias('@' . str_replace('\\', '/', $baseNs)) . '/' . $prefix . $modelClassName . '.php',
                $this->render('base-model.php', $params)
            );

            if ($this->useMidClass) {
                $files[] = new CodeFile(
                    Yii::getAlias('@' . str_replace('\\', '/', $baseNs)) . '/' . 'Mid' . $modelClassName . '.php',
                    $this->render('mid-model.php', $params)
                );
            }
            $files[] = new CodeFile(
