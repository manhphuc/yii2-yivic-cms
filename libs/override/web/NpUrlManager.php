...
/**
 * Class NpUrlManager
 * @package yivic\yivicCms\libs\override\web
 * Thanks to https://github.com/codemix/yii2-localeurls
 */
class NpUrlManager extends UrlManager
{
	/**
